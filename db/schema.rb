...
ActiveRecord::Schema[7.1].define(version: 2024_01_22_232158) do
  ...
  create_table "comments", force: :cascade do |t|
    ...
    t.index ["regular_user_id"], name: "index_comments_on_regular_user_id"
  end
  ...
  create_table "regular_users", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["user_id"], name: "index_regular_users_on_user_id"
  end
  ...
  add_foreign_key "comments", "regular_users"
  add_foreign_key "musicians", "users"
  add_foreign_key "posts", "musicians"
  add_foreign_key "regular_users", "users"
end
